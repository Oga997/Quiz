			...
			<div class="container">
				<div class="mu-header-area">
					...
					<div class="mu-logo-area">
						<!-- text based logo -->
						<a class="mu-logo" href="#">Quiz App</a>
						<!-- image based logo -->
					...
					<div class="mu-header-featured-area">
						...
						<div class="mu-header-featured-content">
							<h1>Welcome To <span>Quiz App</span></h1>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="mu-feature-content-left">
											<img class="mu-profile-img" src="assets/images/image.jfif" alt="iphone Image">
										</div>
									</div>
									<div class="col-md-6">
										<div class="mu-feature-content-right">
											...
											<div class="media">
						                        ...
						                        <div class="media-body">
							                        <h3 class="media-heading">Evaluate your performance</h3>
					...
					<div class="col-md-12">
						<div class="mu-apps-screenshot-area">
							...
							<div class="mu-title-area">
								...
								<span class="mu-title-dot"></span>
								<p>Here you can see our application screenshots</p>
							</div>
							...
							<div class="mu-apps-screenshot-content">
								...
								<div class="mu-apps-screenshot-slider">
									...
									<div class="mu-single-screeshot">
										<img src="assets/images/screenshot/10.png" alt="App screenshot img">
									</div>
								...
								<div class="panel-group" id="accordion">
							          ...
							          <div class="panel-heading">
							            <h4 class="panel-title">
							              <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true">
							                <span class="fa fa-minus"></span> What is Quiz App? 
							              </a>
							            </h4>
							          </div>
							          <div id="collapseOne" class="panel-collapse collapse in">
							            <div class="panel-body">
							              Our application helps students to test their knowledge and also helps teachers to create weekly quizes which will also help them to evaluate each student performances.
							            </div>
							          </div>
							        </div>
							        ...
							        <div class="panel panel-default">
							          ...
							          <div id="collapseTwo" class="panel-collapse collapse">
							            <div class="panel-body">
							              After getting the '.exe' file you easily download in your pc
							            </div>
							          </div>
							        </div>
							        ...
							        <div class="panel panel-default">
							          ...
							          <div id="collapseFive" class="panel-collapse collapse">
							            <div class="panel-body">
							              Yes, you can contact us through our given mail.
							            </div>
							          </div>
							        </div>
